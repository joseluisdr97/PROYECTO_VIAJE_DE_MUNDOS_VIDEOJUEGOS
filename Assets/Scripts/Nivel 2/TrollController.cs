...
public class TrollController : MonoBehaviour
{
    ...
    {
        if (EstoySiendoAtacado == false)
        {
            CambiarAnimacion(ANIMATION_CAMINAR);//Accion correr
        }
        else
        {
            CambiarAnimacion(ANIMATION_ATACAR);//Accion correr
        }
    ...
    {
        if (collision.gameObject.name == "PosicionAtacado" | collision.gameObject.tag == "PosicionAtacado")
        {
